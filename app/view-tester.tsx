...
export default function ViewFunctionTester() {
    const sdk = useSdk();
    ...
    return (
        <View className="flex-1 bg-background">
            <Stack.Screen options={{ title: 'View Function Tester' }} />
            ...
            <ScrollView className="flex-1">
                <View className="mx-auto w-full max-w-screen-lg px-4 py-4">
                    <View className="flex-row items-center mb-5">
                        ...
                        <Text className="text-white text-2xl font-bold">View Function Tester</Text>
                    </View>
